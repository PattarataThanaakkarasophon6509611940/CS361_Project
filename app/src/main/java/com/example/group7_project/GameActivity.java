...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scene_1t5);
        ...
        ImageView imgScene = findViewById(R.id.imgScene_1t5);
        TextView text = findViewById(R.id.textScene_1t5);
        ...
        btnNext.setOnClickListener(v -> {
            switch (sceneIndex[0]) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    imgScene.setImageResource(R.drawable.scene_1_5);
                    text.setText(R.string.scene_1_5);
                    sceneIndex[0] = 5; // เปลี่ยนเป็น Scene 5
                    break;
                default:
